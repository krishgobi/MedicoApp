...
def answer_from_db(user_message):
    ...
    if 'subject' in user_message or 'subjects' in user_message or 'subjects list' in user_message or 'subjects button' in user_message:
        ...
        lines = [f'<li>{s.namesub} (Staff: {s.staffname}, Note: {s.note})</li>' for s in subjects]
    ...
    # Default
    return "Sorry, I couldn't understand. Try asking about <b>subjects</b>, <b>staff</b>, <b>patients</b>, <b>reminders</b>, <b>diseases</b>, or <b>files</b>."
